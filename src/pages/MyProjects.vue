        ...
        <div class="main ">
            ...
            <div class="projects">
                ...
                <div class="project" v-for="(elem, index) in text" :key="index">
                    <div class="project__block" tabindex="0" @click="toggleProject(index)"
                        @keydown.enter.prevent="toggleProject(index)" @keydown.space.prevent="toggleProject(index)">
                        <h3 class="project__name">{{ elem.name }} </h3>
                        <svg :class="{ 'project__plus': true, 'rotate': activeIndex === index }" fill="#FFFFFF"
                    ...
                    <transition name="accordion">
                        <div class="accordion" v-show="activeIndex === index">
                            ...
                            <p class="project__link">Ссылка на деплой: <a target="_blank" :href="elem.link">{{ elem.link
                            }}</a>
                            </p>
