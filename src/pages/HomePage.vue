    ...
    <div class="home">
        <div class="home__photo">
            <div class="photo__left">
                <svg fill="#ffffff" width="80px" height="80px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div class="photo__right">
                <svg fill="#ffffff" width="80px" height="80px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m9 19 8-7-8-7z"/></svg>
            </div>
        </div>
